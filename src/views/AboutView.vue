...
<div class="container mx-auto">
  <div class="flex flex-wrap items-center">
    <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
      <div class="relative flex flex-col min-w-0 break-words bg-indigo-700 w-full mb-6 shadow-lg rounded-lg">
        ...
        <blockquote class="relative p-8 mb-4">
          <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="absolute left-0 w-full block h-95-px -top-94-px">
            <polygon points="-30,95 583,95 583,65" class="text-indigo-700 fill-current"></polygon>
          </svg>
          <h4 class="text-xl font-bold text-white">
            About this  project
          </h4>
          <p class="text-md font-light mt-2 text-white">
           A contact manager website built with Vue.js and Firebase.
           This will help you to manage your contacts.
           You can add, edit, delete and search contacts.
        ...
        <div class="w-full md:w-6/12 px-4">
          <div class="relative flex flex-col min-w-0 mt-4">
            <div class="px-4 py-5 flex-auto">
              ...
              <p class="mb-4 text-blueGray-500">
                This is a project made with Vue Js and Tailwind Css.
              </p>
            </div>
          </div>
          <div class="relative flex flex-col min-w-0">
            <div class="px-4 py-5 flex-auto">
              ...
              <p class="mb-4 text-blueGray-500">
                For more about this project, please visit the documentation.
              </p>
            </div>
          </div>
        </div>
